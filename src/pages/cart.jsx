...
function Cart() {
  ...
  const idPizzas = Object.keys(items);

  const onPlusItem = (id, index) =>
    dispatch(
      plusItem({
        id,
        index,
  ...
  const doPay = () => {
    alert("Наивкуснейшая пицца уже в пути ;)");
  };
      ...
      {totalCount ? (
        <div className="cart">
          ...
          <div className="content__items">
            {idPizzas.map((id) =>
              items[id].items.map((props, index) => (
                <CartItem
                  {...props}
                  index={index}
                  onDeleteItem={onDeleteItem}
                  addCartItem={onPlusItem}
                  subCartItem={onMinusItem}
          ...
          <div className="cart__bottom">
            ...
            <div className="cart__bottom-buttons">
              ...
              <Button onClick={doPay} className="pay-btn">
